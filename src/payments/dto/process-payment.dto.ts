...
export class ProcessPaymentDto {
  ...
  @ApiPropertyOptional({
    description: 'Token gerado pelo SDK do PagSeguro no frontend',
    example: 'tok_xxxxxxxxxxxxxxxx',
  })
  @ValidateIf((o) => o.paymentMethod === PaymentMethod.CREDIT_CARD)
  @IsNotEmpty({
    message:
      'Token do cartão de crédito é obrigatório para pagamento via Cartão de Crédito.',
  })
  @IsString()
  cardToken?: string;
  ...
  @IsNotEmpty({
    message:
      'Nome do titular do cartão é obrigatório para pagamento via Cartão de Crédito.',
  })
  @IsString()
  ...
  @IsNotEmpty({
    message:
      'CPF do titular do cartão é obrigatório para pagamento via Cartão de Crédito.',
  })
  @IsString()
  cardCpf?: string;
  ...
  @ApiPropertyOptional({
    description: 'Bandeira do cartão (e.g., VISA, MASTERCARD)',
    example: 'VISA',
  })
  @ValidateIf((o) => o.paymentMethod === PaymentMethod.CREDIT_CARD)
  @IsOptional()
